...
class DashboardWindow(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle('AutoVerify DX: eficiência e precisão na inspeção visual automotiva.')
        ...
        # Logo Honda
        logo_label = QLabel()
        # Usa Path para garantir compatibilidade entre sistemas operacionais
    ...
    def load_modules(self, grid):
        ...
        auxiliary_modules = {'database_manager', 'model_selector', '__init__'}
    ...
    def open_module(self, module_name):
        try:
            # Adiciona o diretório 'modulos' ao caminho de busca do Python
            modulos_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'modulos')
